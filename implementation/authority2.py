...
def save_authorities_names(api, process_instance_id):
    ...
    print('The time for hash file generation by authority 2 is :', (generate_hash_file_time - start) * 10 ** 3, 'ms')
    print('The time for blockchain execution by authority 2 is :',
          (blockchain_execution - generate_hash_file_time) * 10 ** 3, 'ms')
    print('The time for local saving by authority 2 is :', (local_saving - blockchain_execution) * 10 ** 3, 'ms')
...
def initial_parameters_hashed(groupObj, process_instance_id):
    ...
    print('The time for elements generation by authority 2 is :', (elements_generation - start) * 10 ** 3, 'ms')
    print('The time for elements hashing by authority 2 is :', (elements_hashing - elements_generation) * 10 ** 3, 'ms')
    print('The time for blockchain execution by authority 2 is :', (blockchain_execution - elements_hashing) * 10 ** 3,
          'ms')
    print('The time for local saving by authority 2 is :', (local_saving - blockchain_execution) * 10 ** 3, 'ms')
...
def initial_parameters(process_instance_id):
    ...
    blockchain_execution = time.time()
    print('The time for local retrieve by authority 2 is :', (local_retrieve - start) * 10 ** 3, 'ms')
    print('The time for blockchain execution by authority 2 is :', (blockchain_execution - local_retrieve) * 10 ** 3,
          'ms')
...
def generate_public_parameters(groupObj, maabe, api, process_instance_id):
    ...
    print('The time to retrieve auth1 elements by authority 2 is :', (retrieve_auth2_parameters_time - start) * 10 ** 3,
          'ms')
    print('The time to retrieve auth2 elements by authority 2 is :',
          (retrieve_auth1_parameters_time - retrieve_auth2_parameters_time) * 10 ** 3, 'ms')
    print('The time to retrieve auth3 elements by authority 2 is :',
          (retrieve_auth3_parameters_time - retrieve_auth1_parameters_time) * 10 ** 3, 'ms')
    print('The time to retrieve auth4 elements by authority 2 is :',
          (retrieve_auth4_parameters_time - retrieve_auth3_parameters_time) * 10 ** 3, 'ms')
    print('The time to generate values by authority 2 is :',
          (generate_values_time - retrieve_auth4_parameters_time) * 10 ** 3, 'ms')
    print('The time to generate parameters by authority 2 is :',
          (generate_parameters_time - generate_values_time) * 10 ** 3, 'ms')
    print('The time to generate hash file by authority 2 is :',
...
def generate_pk_sk(groupObj, maabe, api, process_instance_id):
    ...
    print('The time to local retrieve by authority 2 is :', (local_params_retrieve - start) * 10 ** 3, 'ms')
    print('The time to generate keys by authority 2 is :', (generation_keys_time - local_params_retrieve) * 10 ** 3,
          'ms')
    print('The time to generate hash file by authority 2 is :',
