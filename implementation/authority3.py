...
def generate_public_parameters(groupObj, maabe, api, process_instance_id):
    ...
    print('The time to retrieve auth3 elements by authority 3 is :', (retrieve_auth3_parameters_time - start) * 10 ** 3,
          'ms')
    print('The time to retrieve auth1 elements by authority 3 is :',
